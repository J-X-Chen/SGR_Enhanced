...
class SGRAgent(Agent):
    ...
    def update(self, step: int, replay_sample: dict) -> dict:
        ...
        obs, pcd = self._preprocess_inputs(replay_sample)#replay_sample是字典
        '''
        replay_sample.keys()
        dict_keys(['action', 'reward', 'terminal', 'timeout', 'indices', 'low_dim_state', 'low_dim_state_tp1', 
        'front_rgb', 'front_rgb_tp1', 'front_point_cloud', 'front_point_cloud_tp1', 'front_camera_extrinsics', 'front_camera_extrinsics_tp1', 'front_camera_intrinsics', 'front_camera_intrinsics_tp1', 
        'left_shoulder_rgb', 'left_shoulder_rgb_tp1', 'left_shoulder_point_cloud', 'left_shoulder_point_cloud_tp1', 'left_shoulder_camera_extrinsics', 'left_shoulder_camera_extrinsics_tp1', 'left_shoulder_camera_intrinsics', 'left_shoulder_camera_intrinsics_tp1', 
        'right_shoulder_rgb', 'right_shoulder_rgb_tp1', 'right_shoulder_point_cloud', 'right_shoulder_point_cloud_tp1', 'right_shoulder_camera_extrinsics', 'right_shoulder_camera_extrinsics_tp1', 'right_shoulder_camera_intrinsics', 'right_shoulder_camera_intrinsics_tp1', 
        'wrist_rgb', 'wrist_rgb_tp1', 'wrist_point_cloud', 'wrist_point_cloud_tp1', 'wrist_camera_extrinsics', 'wrist_camera_extrinsics_tp1', 'wrist_camera_intrinsics', 'wrist_camera_intrinsics_tp1', 
        'trans_action_indicies', 'trans_action_indicies_tp1', 'trans_action_continuous', 'trans_action_continuous_tp1', 'rot_grip_action_indicies', 'rot_grip_action_indicies_tp1', 'quat', 'quat_tp1', 
        'ignore_collisions', 'ignore_collisions_tp1', 'gripper_pose', 'gripper_pose_tp1', 'lang_goal_emb', 'lang_goal_emb_tp1', 'lang_token_embs', 'lang_token_embs_tp1', 'demo'])
        '''
        #replay_sample['front_point_cloud'].shape ----> torch.Size([16, 3, 128, 128]) front_point_cloud_tp1也是
        ...
        #apply_se3_augmentation操作后size都不变
        # pcd大小没变--> (4,16,3,128,128)
        #action_trans_continuous.shape ---> torch.Size([16, 3])
        #quat.shape ---> torch.Size([16, 4])
        # color drop
